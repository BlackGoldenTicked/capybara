...
import {
  ...
  Upload, BookOpen, Palette, Music, Keyboard, Undo2, type LucideProps
} from 'lucide-react'
...
export type IconName =
  ...
  | 'upload' | 'book' | 'github' | 'twitter' | 'palette' | 'music' | 'keyboard' | 'undo'
...
const MAP: Record<IconName, React.ComponentType<LucideProps>> = {
  ...
  palette: Palette, music: Music, keyboard: Keyboard, undo: Undo2
}
