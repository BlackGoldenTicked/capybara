...
function playSound(cue) {
  ...
  try {
    switch (cue) {
      case "tap":
        noise(ctx, destination, { duration: 8e-3, gain: 0.04, frequency: 3600, filter: "highpass" });
        break;
      case "toggle":
        noise(ctx, destination, { duration: 9e-3, gain: 0.026, frequency: 2800 });
      ...
      case "complete": {
        ...
        [523.25, 659.25, 783.99].forEach(
          (frequency, index) => tone(ctx, destination, {
            at: index * 0.07,
            frequency,
      ...
      case "style":
        ...
        tone(ctx, destination, { at: 0.025, frequency: 1240, endFrequency: 1320, duration: 0.16, gain: 9e-3 });
        break;
      case "hover":
        tone(ctx, destination, { frequency: 1800, endFrequency: 2400, duration: 0.04, gain: 0.012, type: "sine" });
        noise(ctx, destination, { duration: 6e-3, gain: 8e-3, frequency: 4800, filter: "highpass" });
        break;
      case "mark":
...
const Inbox = createLucideIcon("inbox", __iconNode$x);
/**
 * @license lucide-react v1.28.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Library = createLucideIcon("library", __iconNode$t);
/**
 * @license lucide-react v1.28.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const MailOpen = createLucideIcon("mail-open", __iconNode$q);
/**
 * @license lucide-react v1.28.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const MicSignal = createLucideIcon("mic-signal", __iconNode$o);
/**
 * @license lucide-react v1.28.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PanelLeftClose = createLucideIcon("panel-left-close", __iconNode$k);
/**
 * @license lucide-react v1.28.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PanelLeftOpen = createLucideIcon("panel-left-open", __iconNode$j);
/**
 * @license lucide-react v1.28.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Section({ id: id2, title, collapsedSec, onToggle, action, children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sec", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sec-head", onClick: () => onToggle(id2), children: [
...
function Sidebar({ collapsed = false, style, dragging = false, searchRef }) {
  ...
  if (collapsed) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: `sidebar collapsed ${dragging ? "dragging" : ""}`, style, title: "展开侧栏请向右拖动分隔条", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `rail-btn ${activeSourceType === "github" ? "active" : ""}`, title: `GitHub ★（${sourceCounts["github"] || 0}）`, onClick: () => setSourceType("github"), children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rail-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "github", size: 19 }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `rail-btn ${activeSourceType === "x_bookmark" ? "active" : ""}`, title: `Twitter 书签（${sourceCounts["x_bookmark"] || 0}）`, onClick: () => setSourceType("x_bookmark"), children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rail-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "twitter", size: 19 }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rail-sep" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `rail-btn ${screen === "board" ? "active" : ""}`, title: "白板", onClick: () => setScreen("board"), children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rail-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "board", size: 19 }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rail-btn", title: "新建白板", onClick: () => void createBoard(), children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rail-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "plus", size: 19 }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rail-sep" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `rail-btn ${settingsOpen ? "active" : ""}`, title: "系统配置", onClick: () => openSettings(), children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rail-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "settings", size: 19 }) }) })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: `sidebar ${dragging ? "dragging" : ""}`, style, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-search", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ref: searchRef,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "side-ico", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "github", size: 16 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "GitHub ★" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "count", children: sourceCounts["github"] || "" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "nav-sep" }),
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "list-top", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "list-time", children: relTime(item.published_at || item.fetched_at) })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "list-actions", onClick: stop, onDragStart: stop, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "act", title: "用系统默认浏览器打开", onClick: open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "external", size: 14 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `act ${read ? "on" : ""}`, title: read ? "标记为未读" : "标记为已读", onClick: toggleRead, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "check", size: 14 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `act ${later ? "on" : ""}`, title: "稍后读", onClick: laterFn, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "later", size: 14 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `act ${fav ? "on" : ""}`, title: "收藏", onClick: favFn, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "favorite", size: 14, fill: fav ? "currentColor" : "none" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "act danger", title: "删除", onClick: del, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "trash", size: 14 }) })
          ] })
        ]
      }
    ) });
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-meta", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "card-time", children: relTime(item.published_at || item.fetched_at) })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-actions", onClick: stop, onDragStart: stop, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "act", title: "用系统默认浏览器打开", onClick: open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "external", size: 15 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `act ${read ? "on" : ""}`, title: read ? "标记为未读" : "标记为已读", onClick: toggleRead, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "check", size: 15 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `act ${later ? "on" : ""}`, title: "稍后读", onClick: laterFn, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "later", size: 15 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `act ${fav ? "on" : ""}`, title: "收藏", onClick: favFn, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "favorite", size: 15, fill: fav ? "currentColor" : "none" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "act danger", title: "删除", onClick: del, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "trash", size: 15 }) })
        ] })
      ]
    }
  ) });
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "feed-header", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "feed-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "feed-actions", children: [
        ...
        (view === "rss" || view === "podcast" || view === "video") && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "mini", title: `把${viewLabel}未读全部标为已读`, onClick: () => void markAllRead(view), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "check", size: 13 }),
            " 标为已读"
          ] }),
          view === "rss" && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "mini", title: "清空 RSS（保留收藏与白板引用）", onClick: onClear, children: [
...
function QuickAdd() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-mask", onClick: () => setQuickAddOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal", onClick: (e) => e.stopPropagation(), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal-foot", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setQuickAddOpen(false), children: "取消" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => void submit(), disabled: busy, children: busy ? "抓取中…" : "收集" })
    ] })
  ] }) });
}
...
function CardEditor({ card, itemMap, onClose, onSave, onDelete, onOpenItem }) {
  ...
  const assetSrc = p2.file ? `board-asset://${p2.file}` : p2.url || "";
  const saveText = () => onSave({ title, body });
  const saveLink = () => onSave({ title, body: note, payload: JSON.stringify({ url, note }) });
  const saveAsset = (sourcePath) => onSave({ body: note, payload: JSON.stringify({ ...p2, note, url: p2.url }), _sourcePath: sourcePath });
  const onReplace = (e) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-mask", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal card-editor", onClick: (e) => e.stopPropagation(), children: [
    ...
    (card.kind === "image" || card.kind === "video" || card.kind === "file") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "edit-body", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "asset-preview", children: [
        ...
        card.kind === "video" && assetSrc && /* @__PURE__ */ jsxRuntimeExports.jsx("video", { src: assetSrc, controls: true }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal-foot", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, children: "完成" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "primary", onClick: () => {
...
function BoardView() {
  const { cards, links, activeBoardId, boards, createBoard, addRefCard, addCard, moveCard, deleteCard, showToast: showToast2, addLink, deleteLink, updateLink, renameBoard, deleteBoard, autoPos } = useStore();
  ...
  const onDrop = (e) => {
    ...
    if (files.length) showToast2(`已添加 ${files.length} 个附件`);
  };
  ...
  const beginRename = () => {
    const b = boards.find((x2) => x2.id === activeBoardId);
    setEditingName(true);
    setNameDraft(b?.name ?? "");
  };
  ...
  const commitRename = () => {
    if (activeBoardId != null) void useStore.getState().renameBoard(activeBoardId, nameDraft.trim() || "未命名白板");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "board", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "board-toolbar", onPointerDown: (e) => e.stopPropagation(), children: [
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "title", onDoubleClick: beginRename, title: "双击重命名", children: board?.name ?? "白板" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "board-card-btns", children: CARD_TYPES.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { title: t2.desc, onClick: () => onPickType(t2.kind), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: t2.icon, size: 15 }),
        " ",
        t2.label
      ] }, t2.kind)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "board-tools", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "缩小", onClick: () => setZoom((z2) => Math.max(0.3, z2 - 0.15)), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "minus", size: 16 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { title: "还原视图", onClick: fit, style: { minWidth: 52, fontVariantNumeric: "tabular-nums" }, children: [
          Math.round(zoom * 100),
          "%"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "放大", onClick: () => setZoom((z2) => Math.min(2.5, z2 + 0.15)), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "plus", size: 16 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "danger", title: "删除白板", onClick: () => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "board-edges", width: "100%", height: "100%", children: [
              ...
              links.map((lk2) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { className: "edge", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d, className: "edge-hit", fill: "none" }),
            ...
            cardsView.map(({ card, p: p2 }) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  className: `board-card kind-${card.kind}`,
                  ...
                  children: [
                    ...
                    (hoveredId === card.id || linking != null) && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "card-link-dot card-link-top", title: "从上边连线", onPointerDown: (e) => startLink(e, card) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "card-link-dot card-link-right", title: "从右边连线", onPointerDown: (e) => startLink(e, card) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "card-link-dot card-link-bottom", title: "从下边连线", onPointerDown: (e) => startLink(e, card) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "card-link-dot card-link-left", title: "从左边连线", onPointerDown: (e) => startLink(e, card) })
                    ] }),
                    ...
                    card.kind === "link" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "bc-kind", children: [
                    ...
                    card.kind === "image" && assetSrc && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "bc-media", src: assetSrc, alt: p2.name || card.title }),
...
function DiscoverPanel() {
  const { addFeed, showToast: showToast2 } = useStore();
  ...
  const doAdd = async (feed) => {
    ...
    try {
      ...
      showToast2(`已添加「${feed.title}」为${KIND_LABEL$2[pickKind]}`);
      setPicking(null);
      setRows((prev) => prev.map((x2) => x2.id === feed.id ? { ...x2, subscribed: 1 } : x2));
    } catch (e) {
      showToast2("添加失败：" + e.message);
    } finally {
      setAdding(false);
    }
  };
...
function RssManager() {
  const { feeds, addFeed, deleteFeed, refreshFeed, showToast: showToast2 } = useStore();
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "subs-row", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "set-card", children: [
        ...
        feeds.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "subs-wrap", children: feeds.map((f2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "feed-row", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => void deleteFeed(f2.id), children: "删除" })
        ] }, f2.id)) })
      ] })
    ] }),
...
function GithubStarManager() {
  const { fetchGithubStars, showToast: showToast2 } = useStore();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "set-scroll", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "set-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "src-field src-actions-field", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": "true" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "src-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => void fetchStars(), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "github", size: 14 }),
            " 拉取 Star"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "src-hint src-grow", children: ghMsg || (hasToken ? "已授权（Token 加密存储）" : "未设置 Token（公开 API 速率 60 次/小时）") })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "set-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "src-grid-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "src-field", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "src-actions", id: "github-login-btn", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => void deviceLogin(), disabled: loggingIn, children: loggingIn ? "等待浏览器授权…" : "一键登录 GitHub" }) })
        ] })
      ] }),
      userCode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "src-field", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "验证码（已复制到剪贴板，粘贴到 GitHub 授权页）" }),
...
function TwitterBookmarkManager() {
  const { importTwitterBookmarks, showToast: showToast2 } = useStore();
...
function DiagPanel() {
  const { feeds, load, loadFeeds, showToast: showToast2 } = useStore();
...
function SettingsView() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-modal-mask", onClick: closeSettings, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings settings-modal", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "settings-nav", children: TABS.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: `set-nav ${settingsTab === t2.key ? "active" : ""}`, onClick: () => setSettingsTab(t2.key), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "settings-close", title: "关闭设置", onClick: closeSettings, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "close", size: 16 }) })
  ] }) });
}
function AppearanceTab() {
  const { appearance, soundEnabled, soundVolume, updateAppearance, setSoundEnabled: setSoundEnabled2, setSoundVolume: setSoundVolume2, logo, setLogo } = useStore();
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "switch-row", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: () => setSoundEnabled2(!soundEnabled),
...
function ActionsTab({ onRefresh }) {
  const { clearInbox, purge, showToast: showToast2, developerMode, setDeveloperMode, dbPath, setDbPath } = useStore();
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "set-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "src-actions", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: async () => {
          ...
          if (r2.ok) {
            showToast2(`已导入 ${r2.imported ?? 0} 项设置，请重启应用生效`);
            void useStore.getState().initAppearance();
          } else {
            showToast2("导入失败：" + (r2.error || "未知错误"));
          }
        }, children: [
...
${f2.last_error || "未知错误"}` : f2.name,
                onClick: () => setActiveFeed(activeFeed === f2.name ? null : f2.name),
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      className: `feed-refresh ${refreshingId === f2.id ? "spinning" : ""}`,
                      title: "只刷新此源",
                      onClick: (e) => {
                        e.stopPropagation();
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main", children: [
      !isZen && !sideHidden && /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { collapsed: sideCollapsed, style: sidebarStyle, dragging, searchRef }),
